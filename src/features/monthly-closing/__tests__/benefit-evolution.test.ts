...
describe("buildBenefitEvolution", () => {
  ...
  it("currentBalance soma todos os movimentos, inclusive fora da janela", () => {
    ...
    expect(evolution.currentBalance).toBe(50)
  ...
  it("retorna vazio quando não há conta de benefício", () => {
    ...
    expect(evolution).toEqual({ points: [], credited: 0, spent: 0, currentBalance: 0, averageDaily: 0, movementEnd: null, creditStart: null })
  })
