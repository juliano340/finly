...
export const releases = [
  {
    ...
    date: "2026-09-22",
    changes: [
      { type: "feat", description: "Landing reescrita com copy honesta em primeira pessoa, recursos reais e seção de engenharia com link para o GitHub." },
    ],
  },
  {
    version: "0.2.86",
  ...
  },
  {
    ...
    date: "2026-09-19",
    changes: [
      { type: "feat", description: "O Fechamento Mensal e o Dashboard agora mostram o resultado também sem o benefício: o valor principal segue com o VA e o detalhe abre 'Sem VA: ... · Benefício: +... (estimado)' quando houver benefício." },
    ],
  },
  {
    version: "0.2.72",
  ...
  },
  {
    ...
    date: "2026-09-19",
    changes: [
      { type: "feat", description: "O Fechamento Mensal ganhou dois gráficos: 'Evolução dos gastos' (sem misturar o VA) e 'Evolução do saldo do benefício', com o ciclo desde a última recarga, média de gasto por dia, opção de ver até o fim do mês e tooltip listando os lançamentos do dia." },
    ],
  },
  {
    version: "0.2.70",
  ...
  },
  {
    ...
    date: "2026-09-19",
    changes: [
      { type: "fix", description: "Após excluir transações em lote, a lista se atualiza sozinha, sem precisar recarregar a página." },
    ],
  },
  {
    version: "0.2.65",
  ...
  },
  {
    ...
    date: "2026-09-18",
    changes: [
      { type: "feat", description: "O card Despesas do mês agora segue a mesma composição do card Receitas: despesas sem VA + VA (benefício) = total, no desktop e no celular." },
    ],
  },
  {
    version: "0.2.63",
    date: "2026-09-18",
    changes: [
      { type: "feat", description: "O card Receitas do mês agora mostra a composição do valor: renda + VA (benefício) = total, no desktop e no celular, com o selo 'estimado' quando o crédito do mês ainda não foi lançado." },
    ],
  },
  {
    version: "0.2.62",
  ...
  },
  {
    ...
    date: "2026-09-17",
    changes: [
      { type: "feat", description: "Ao criar ou editar um lançamento com data de outro mês, a lista de transações vai automaticamente para o mês da data, com um aviso de redirecionamento." },
    ],
  },
  {
    version: "0.2.59",
  ...
  },
  {
    ...
    date: "2026-09-16",
    changes: [
      { type: "feat", description: "No seletor de mês, Ctrl/Cmd + setas esquerda/direita troca o mês em qualquer tela que usa o componente, com dica no botão e sem interferir em campos de texto ou diálogos abertos." },
    ],
  },
  {
    version: "0.2.57",
  ...
  },
  {
    ...
    date: "2026-09-16",
    changes: [
      { type: "feat", description: "A paginação do changelog agora aparece também no topo da lista, com os mesmos controles do rodapé." },
    ],
  },
  {
    version: "0.2.55",
  ...
  },
  {
    ...
    date: "2026-09-13",
    changes: [
      { type: "fix", description: "O sheet de edição de ocorrências de custos fixos perdeu o espaçamento residual no topo, ficando alinhado ao padrão dos demais formulários." },
    ],
  },
  {
    version: "0.2.40",
